			...
			<div class="wrapper">
				<div class="col-md-8">
					<div class="card">
						...
						<div class="header">
							<h4 class="title">Yeni Tarif Ekle</h4>
						</div>
						<div class="content" id="genel">
							<div class="form-group row">
								<label class="col-sm-4 col-form-label">Tarif Adı</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="tarifadi" placeholder="Tarif Adı" id="tarifisim" autofocus>
								</div>
							</div>
							<div class="form-group row">
								<label for="inputPassword3" class="col-sm-4 col-form-label">Porsiyon Adedi</label>
								<div class="col-sm-8">
							...
							<div class="form-group row">
								<label for="inputEmail3" class="col-sm-4 col-form-label">İçindekiler</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<textarea rows="5" class="form-control" placeholder="Hazırlanışı" name="hazirlanisi" id="hazirlanisi"></textarea>
							</div>


							<div style="display: flex; justify-content: flex-end;">
								<button type="submit" id="genelekle" class="btn btn-default">Tarifi Kaydet</button>
							</div>
						</div>
					</form>
...
<script>
		...
		function kaydet(){
			...
			if(tarifadi==""){
				...
				var g="isim="+tarifadi+"&tpor="+tpor+"&tene="+tene+"&tkar="+tkar+"&tpro="+tpro+"&tyag="+tyag+"&hazirlanisi="+hazirlanisi;
				$.ajax({
					type: "POST",
					url: "tarifkayit.php",
					data: g,
